    ...
    <div class="grid-3">
      ...
      <article class="testimonial-card" aria-label="Review by {{ review.name }}">
        ...
        <div class="testimonial-screenshot">
          <img src="{{ review.screenshot | relative_url }}"
               alt="Screenshot of review by {{ review.name }}"
               loading="lazy">
        </div>
        {% elsif review.text %}
        ...
        <div class="testimonial-author">
          ...
          <div class="author-info">
            ...
            {% if review.country or review.date %}<span class="author-meta">{% if review.country %}{{ review.country }} · {% endif %}{{ review.date }}</span>{% endif %}
          </div>
        </div>
        {% if review.tour %}
        ...
        <div class="testimonial-source">
          ...
          <span>{% if review.url %}View on{% else %}Posted on{% endif %} TripAdvisor</span>
          {% if review.url %}</a>{% endif %}
        </div>
        {% elsif review.source == "google" %}
        <div class="testimonial-source">
